...
- Name: dashboard-checkin.spec.ts >> Dashboard - Fluxo de Check-in >> deve permitir desfazer check-in manual
- Location: e2e/dashboard-checkin.spec.ts:73:7
