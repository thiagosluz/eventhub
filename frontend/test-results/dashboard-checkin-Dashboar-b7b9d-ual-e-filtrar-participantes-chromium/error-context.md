...
- Name: dashboard-checkin.spec.ts >> Dashboard - Fluxo de Check-in >> deve alternar para aba manual e filtrar participantes
- Location: e2e/dashboard-checkin.spec.ts:36:7
...
Call log:
  - waiting for getByPlaceholder('Busque por nome, e-mail ou código...')
          ...
          - generic [ref=e69]:
            ...
            - generic [ref=e82]:
              - button "Scanner QR" [ref=e83]:
                - img [ref=e84]
                - text: Scanner QR
              - button "Manual / Busca" [active] [ref=e87]:
                - img [ref=e88]
                - text: Manual / Busca
            - generic [ref=e90]:
