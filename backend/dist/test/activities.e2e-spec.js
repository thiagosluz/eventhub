...
describe('Activities (e2e)', () => {
    ...
    beforeEach(async () => {
        const moduleFixture = await testing_1.Test.createTestingModule({
            ...
            .overrideProvider((0, bullmq_1.getQueueToken)('activities'))
            .useValue(mockQueue)
            .overrideProvider((0, bullmq_1.getQueueToken)('assign-reviews'))
            .useValue(mockQueue)
            .overrideProvider((0, bullmq_1.getQueueToken)('emails'))
            .useValue(mockQueue)
            .overrideProvider(activities_processor_1.ActivitiesProcessor)
            .useValue({ process: jest.fn() })
            .overrideProvider(submissions_processor_1.AssignReviewsProcessor)
            .useValue({ process: jest.fn() })
            .overrideProvider(mail_processor_1.MailProcessor)
            .useValue({ process: jest.fn() })
            .compile();
        const fetchTenant = () => {
            mockPrismaService.event.findFirst.mockResolvedValue({ id: 'e1', tenantId: 'tenant_1' });
            mockPrismaService.activity.create.mockResolvedValue({ id: 'a1', requiresEnrollment: true });
            ...
            mockPrismaService.activity.findUnique.mockResolvedValue({ id: 'a1', eventId: 'e1', speakers: [], enrollments: [] });
            ...
            mockPrismaService.activityEnrollment.create.mockResolvedValue({ id: 'en1' });
            mockPrismaService.activityEnrollment.createMany.mockResolvedValue({ count: 0 });
        };
    ...
    describe('POST /activities/:activityId/enroll', () => {
        it('should enroll a participant successfully', async () => {
            ...
            mockPrismaService.activityEnrollment.findMany.mockResolvedValue([]);
            mockPrismaService.activityEnrollment.findFirst.mockResolvedValue(null);
            mockPrismaService.activityEnrollment.create.mockResolvedValue({ id: 'enc1' });
            return (0, supertest_1.default)(app.getHttpServer())
    ...
    describe('PATCH /activities/:activityId', () => {
        it('should update an activity', async () => {
            ...
            mockPrismaService.activity.findFirst.mockResolvedValue({ id: 'a1', speakers: [], enrollments: [], event: { tenantId: 'tenant_1' } });
            mockPrismaService.activity.findUnique.mockResolvedValue({ id: 'a1', eventId: 'e1', speakers: [], enrollments: [] });
            return (0, supertest_1.default)(app.getHttpServer())
                .patch('/activities/a1')
                .set('Authorization', `Bearer ${token}`)
    ...
    describe('Activity Management & Enrollments', () => {
        ...
        it('should unroll from an activity', async () => {
            ...
            mockPrismaService.activityEnrollment.delete.mockResolvedValue({ id: 'en1' });
            return (0, supertest_1.default)(app.getHttpServer())
        ...
        it('should delete an activity (Organizer)', async () => {
            ...
            mockPrismaService.activitySpeaker.deleteMany.mockResolvedValue({ count: 0 });
            mockPrismaService.activityEnrollment.deleteMany.mockResolvedValue({ count: 0 });
        ...
        it('should confirm an enrollment (Organizer)', async () => {
            ...
            mockPrismaService.activityEnrollment.findUnique.mockResolvedValue({ id: 'en1', activityId: 'a1', status: 'PENDING' });
            mockPrismaService.activityEnrollment.update.mockResolvedValue({ id: 'en1', status: 'CONFIRMED' });
            return (0, supertest_1.default)(app.getHttpServer())
    ...
    describe('Activity Types (Full CRUD)', () => {
        ...
        it('should delete an activity type', async () => {
            ...
            mockPrismaService.activityType.findFirst.mockResolvedValue({ id: 't1', tenantId: 'tenant_1' });
