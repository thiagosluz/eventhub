...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Create a new event (Organizer only)" }),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(roles_types_1.UserRole.ORGANIZER),
    (0, swagger_1.ApiOperation)({ summary: "Upload event banner" }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "List all public events" }),
