...
describe("ActivitiesController", () => {
  ...
  describe("Activity Types", () => {
    ...
    it("createType should throw if tenantId missing", async () => {
      await expect(
        controller.createType({ user: {} } as any, "Type A"),
    ...
    it("findAllTypes should throw if tenantId missing", async () => {
      await expect(
        controller.findAllTypes({ user: {} } as any),
      ).rejects.toThrow("Missing tenantId");
    });
    ...
    it("removeType should throw if tenantId missing", async () => {
      await expect(
        controller.removeType({ user: {} } as any, "type-id"),
      ).rejects.toThrow("Missing tenantId");
    });
  });
  ...
  describe("listEnrollments", () => {
    ...
    it("should throw if tenantId missing", async () => {
      await expect(
        controller.listEnrollments("activity-id", { user: {} } as any),
      ).rejects.toThrow("Missing tenantId");
    });
  });
  ...
  describe("confirmEnrollment", () => {
    it("should work", async () => {
      await controller.confirmEnrollment(
        "activity-id",
        "enrollment-id",
        mockRequest,
      );
    ...
    it("should throw if tenantId missing", async () => {
      await expect(
        controller.confirmEnrollment("activity-id", "enrollment-id", {
          user: {},
        } as any),
      ).rejects.toThrow("Missing tenantId");
    });
